 ...
 * @since 6/10/2026
 */
@Schema(name = "CreateTargetApiConnectorRequest", description = "Create target connector payload")
public record CreateTargetApiConnectorRequest(
    @Schema(description = "Connector name.", example = "Mock Health Chatbot")
    ...
    @Schema(description = "HTTP method.", example = "POST") @NotNull(message = "Method is required.")
        HttpMethodType method,
    @Schema(description = "Base URL.", example = "http://localhost:8080", nullable = true)
        String baseUrl,
    @Schema(description = "Request path.", example = "/mock-chatbot/chat", nullable = true)
        String path,
    @Schema(description = "Full target URL.", example = "http://localhost:8080/mock-chatbot/chat")
    ...
    @Schema(description = "Response selector.", example = "$.answer")
        @NotBlank(message = "Response selector is required.")
        String responseSelector,
    @Schema(description = "Whether the target streams responses.", example = "false") Boolean isStreaming,
    ...
    @Schema(description = "Retry count.", example = "1")
