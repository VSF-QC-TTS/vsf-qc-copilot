 ...
 * @since 6/10/2026
 */
@Schema(name = "RequirementResponse", description = "Business requirement detail payload")
public record RequirementResponse(
    @Schema(
            description = "Public requirement identifier. Internal numeric ids are never exposed.",
    ...
    @Schema(description = "Last requirement update time.", example = "2026-06-08T10:30:00+07:00")
