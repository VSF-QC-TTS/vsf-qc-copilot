...
description: Apply core coding standards, dependency injection, and configuration for Spring Boot 4. Use when applying Spring Boot 3 coding standards or configuring dependency injection.
metadata:
  triggers:
    files:
